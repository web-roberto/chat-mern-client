...
const successCallBack =()=> console.log('ok');
  ...
  return (
    ...
    {/* add to top of file. Only use once.   */}
      ...
      //  sources={['local', 'camera', 'dropbox']} // set the sources available for uploading -> by default
        ...
        cloudName={'web-roberto'} // your cloudinary account cloud name. 
        // Located on https://cloudinary.com/console/
        uploadPreset={'chatdb'} // check that an upload preset exists and check mode is signed or unisgned
        buttonText={'Picture'} // default 'Upload Files'
        style={{
              marginTop: '4px',
              color: 'white',
              border: 'none',
        ...
        folder={'my_uploads'} // set cloudinary folder name to send file
